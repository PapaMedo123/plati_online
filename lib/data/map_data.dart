...
/// Represents the results from the Google Places API.
class PlacesApiResults {
  ...
  factory PlacesApiResults.fromRawJson(String str) =>
      PlacesApiResults.fromJson(json.decode(str));
...
/// Represents a result from the Google Places API.
class Result {
  Geometry? geometry;
  String? icon;
...
/// Enum representing the business status.
enum BusinessStatus {
  CLOSED_TEMPORARILY,
  OPERATIONAL
}
...
/// Represents the geometry of a result.
class Geometry {
  ...
  factory Geometry.fromJson(Map<String, dynamic> json) => Geometry(
        location: json["location"] == null
            ? null
            : LocationJsonData.fromJson(json["location"]),
...
/// Represents the location data in JSON format.
class LocationJsonData {
  ...
  factory LocationJsonData.fromRawJson(String str) =>
      LocationJsonData.fromJson(json.decode(str));
...
/// Represents the viewport of a result.
class Viewport {
  ...
  factory Viewport.fromJson(Map<String, dynamic> json) => Viewport(
        northeast: json["northeast"] == null
            ? null
            : LocationJsonData.fromJson(json["northeast"]),
        southwest: json["southwest"] == null
            ? null
            : LocationJsonData.fromJson(json["southwest"]),
      );
...
/// Enum representing icon background colors.
...
/// Represents the opening hours of a result.
class OpeningHours {
  bool? openNow;
...
/// Represents a photo associated with a result.
class Photo {
  int? height;
...
/// Represents the PlusCode of a result.
class PlusCode {
  String? compoundCode;
  String? globalCode;
...
/// Helper class for mapping enum values.
class EnumValues<T> {
  Map<String, T> map;
